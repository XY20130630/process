...
\begin{longtable}{ccccccccccc}
  ...
  \hline
  2017.8.28 & switch & AC & AC & 最短路\\
  & langle & TL & AC & bfs{\color{red}考场上打的dij}\\
  & wish & AC & AC & dp+heap\\
  & campaign & WA & AC & 二次函数{\color{red}打挂了}\\
  \hline
  2017.8.29 & ska & WA & AC & 结论+枚举{\color{red}没想到}\\
  & tet & & AC & 结论+树状数组{\color{red}没想到}\\
  & klo & WA & AC & 树状数组优化dp{\color{red}打挂了}\\
  & gaz & & AC & 模拟{\color{red}没想到}\\
  \hline
\end{longtable}
